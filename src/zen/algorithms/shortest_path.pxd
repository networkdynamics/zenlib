...
cpdef all_pairs_shortest_path(G,ignore_weights=?)
cpdef all_pairs_shortest_path_length(G,ignore_weights=?)
cpdef all_pairs_shortest_path_(G,bint ignore_weights=?)
cpdef all_pairs_shortest_path_length_(G,bint ignore_weights=?)
