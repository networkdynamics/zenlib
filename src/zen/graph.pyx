...
cdef class Graph:
    ...
    **Graph Listeners**:
    ...
    cpdef components(Graph self):
        """
        Return a list of sets of node objects.  Each set corresponds to a component of the graph.

        This is equivalent to calling ``zen.algorithms.components.components(G)``.
        """
